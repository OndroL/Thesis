...
public class InstructorServiceTest {
    ...
    @BeforeEach
    void setUp() {
        // No EntityManager injection needed as BaseService now uses repository exclusively.
    }
    ...
    void testFindAllByActivity_Success() throws FinderException {
        ...
        when(instructorRepository.findAllByActivity(eq(activityId), anyInt(), anyInt(), eq(false)))
        ...
        verify(instructorRepository, times(1)).findAllByActivity(eq(activityId), anyInt(), anyInt(), eq(false));
    }
